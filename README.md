...
* **Принцип дії:** Бот жорстко контролює подію `new_chat_members`. Якщо доданий учасник є ботом (`member.is_bot == True`), і особа, яка його додала, НЕ є адміністратором групи, бот миттєво **банить доданого бота** та **банить користувача-ініціатора** (мастера).
